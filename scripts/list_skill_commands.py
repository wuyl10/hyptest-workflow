...
COMMAND_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ...
            {
                "name": "case-skeleton",
                "cmd": "python3 scripts/make_case_skeleton.py --case <case_name> --preflight-json .hyptest_skill_reports/case_preflight.json --test-point-id <PnX>",
            ...
            },
            {
                ...
                "cmd": "python3 scripts/make_case_submission_card.py --preflight-json .hyptest_skill_reports/case_preflight.json --gate-json .hyptest_skill_reports/case_gate.json --emit-final-draft --json-out .hyptest_skill_reports/submission_card.json --md-out .hyptest_skill_reports/submission_card.md",
            ...
            {
                "name": "timing-summary",
                "cmd": "python3 scripts/case_timing_summary.py --reports '.hyptest_skill_reports/*.json' --json-out .hyptest_skill_reports/timing_summary.json --md-out .hyptest_skill_reports/timing_summary.md",
