...
COMMAND_GROUPS: list[dict[str, Any]] = [
    {
        ...
        "commands": [
            {
                "name": "quick",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/self_check.py --quick --spec-profile <spec_profile>",
                "desc": "Fast skill checks; no simulator environment required.",
            },
            {
                "name": "repo",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/self_check.py --repo --repo-root $HYPTEST_HOME --spec-profile <spec_profile>",
                "desc": "Skill checks plus repo CLI contract, log contract, snapshot, and lint-baseline checks.",
            },
            {
                "name": "full",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/self_check.py --full --repo-root $HYPTEST_HOME --spec-profile <spec_profile> --json --json-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/self_check_full.json --md-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/self_check_full.md",
    ...
    },
    {
        ...
        "commands": [
            {
                "name": "repo-health",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/doctor.py --repo-root $HYPTEST_HOME --pre-submit --strict --spec-profile <spec_profile>",
                "desc": "Grouped profile, skill, repo, CLI contract, lint-baseline, env and self-check health report.",
            },
            {
                "name": "task-request",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/validate_task_request.py --repo-root $HYPTEST_HOME --test-point-file <test_point_file> --platform spike --spec-profile <spec_profile> --task-mode new-case-only --new-case-count 1-3",
                "desc": "Validate task inputs before editing or running cases, including optional workflow-to-triage waveform handoff fields; add --env HYPTEST_SPIKE_BIN=<path> only when the prompt explicitly overrides the runner path.",
            },
            {
                "name": "platform-env",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_env.py --repo-root $HYPTEST_HOME --platform all --explain --print-exports",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_target_module.py --module <target_module>",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/query_spec_profile.py --spec-profile <spec_profile> --nongate-summary --match-module <target_module> --json",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_manual_reference_topic.py --repo-root $HYPTEST_HOME --case <case_name> --module <target_module> --topic <kw1> --topic <kw2> --spec-profile <spec_profile>",
            ...
            {
                "name": "doctor-all",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/doctor.py --repo-root $HYPTEST_HOME --platform all --pre-submit --spec-profile <spec_profile>",
    ...
    },
    {
        ...
        "commands": [
            {
                "name": "similar-cases",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/find_similar_cases.py --repo-root $HYPTEST_HOME --query '<scenario terms>' --limit 5 --explain-score",
                "desc": "Search existing ai/manual case sources before writing a new case.",
            },
            {
                "name": "repo-evidence-index",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/repo_evidence_index.py --repo-root $HYPTEST_HOME --query '<scenario terms>' --json",
                "desc": "Build or reuse a repo-wide cached evidence index for cases, test_points and register status.",
            },
            {
                "name": "workflow-paths",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_paths.py --repo-root $HYPTEST_HOME",
                "desc": "Print unified .hyptest_workflow_skill cache/report/memory/tmp paths.",
            },
            {
                "name": "case-preflight-pack",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/case_preflight_pack.py --repo-root $HYPTEST_HOME --test-point-file <test_point_file> --platform spike --spec-profile <spec_profile> --task-mode new-case-only --new-case-count 1 --query '<scenario terms>' --md-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_preflight.md --json-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_preflight.json",
            ...
            {
                "name": "case-skeleton",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/make_case_skeleton.py --case <case_name> --preflight-json $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_preflight.json --test-point-id <PnX>",
                "desc": "Generate a conservative C skeleton from preflight evidence without deciding case semantics.",
            },
            {
                "name": "case-name-suggest",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/suggest_case_name.py --repo-root $HYPTEST_HOME --preflight-json $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_preflight.json --prefix ai_micro --json",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_case_uniqueness.py --repo-root $HYPTEST_HOME --case <case_name> --expect absent --json",
                "desc": "Check exact case-name uniqueness before editing by reusing the repo evidence cache instead of cold-scanning with rg.",
            },
            {
                "name": "case-lint",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_case_lint.py --repo-root $HYPTEST_HOME --changed-only --strict-case-end --warnings-as-errors",
                "desc": "Lint changed case sources for harness-shape mistakes.",
            },
            {
                "name": "case-lint-baseline",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_case_lint.py --repo-root $HYPTEST_HOME --baseline assets/baselines/case_lint_baseline.json --warnings-as-errors",
                "desc": "Fail only on active lint issues not covered by the known baseline.",
            },
            {
                "name": "cli-contract",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_hyptest_cli_contract.py --repo-root $HYPTEST_HOME",
                "desc": "Check compile/run script platform names, case_elf_asm, required env vars and personal-path regressions.",
            },
            {
                "name": "repo-snapshot",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/repo_snapshot.py --repo-root $HYPTEST_HOME",
                "desc": "Print a read-only snapshot of case sources, register state, test_point coverage, artifacts and latest logs.",
            },
            {
                "name": "baseline-diff",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/case_lint_baseline_diff.py --old <old_baseline.json> --new <new_baseline.json>",
                "desc": "Review added/removed lint baseline issues before accepting a new baseline.",
            },
            {
                "name": "writeback-check",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_writeback_format.py --repo-root $HYPTEST_HOME --file <test_point_file> --check-register --spec-profile <spec_profile>",
                "desc": "Validate lightweight test_point writeback and registration consistency.",
            },
            {
                "name": "case-postcheck-pack",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/case_postcheck_pack.py --repo-root $HYPTEST_HOME --test-point-file <test_point_file> --case <case_name> --platform spike --spec-profile <spec_profile> --md-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_postcheck.md --json-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_postcheck.json",
                "desc": "Collect lint/writeback/register/artifact/log evidence after editing a case.",
            },
            {
                "name": "case-gate-pack",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/case_gate_pack.py --repo-root $HYPTEST_HOME --test-point-file <test_point_file> --case <case_name> --platform spike --spec-profile <spec_profile> --md-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_gate.md --json-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_gate.json --postcheck-md-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_postcheck.md --postcheck-json-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/case_postcheck.json",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_timeline.py start --repo-root $HYPTEST_HOME --timeline-id <case_or_task>_<timestamp> --test-point-file <test_point_file> --platform spike --spec-profile <spec_profile> --task-mode <task_mode> --target-module <module> --phase prompt_intake [--prompt-received-at <iso_time>]",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_timeline.py enter --repo-root $HYPTEST_HOME --timeline <timeline_id> --phase <phase_name>",
                "desc": "Mark a major workflow phase boundary for prompt-to-final timing.",
            },
            {
                "name": "workflow-timeline-finish",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_timeline.py finish --repo-root $HYPTEST_HOME --timeline <timeline_id> --json-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/<timeline_id>_workflow_timeline.json --md-out $HYPTEST_HOME/.hyptest_workflow_skill/reports/<timeline_id>_workflow_timeline.md",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_timed_cmd.py --repo-root $HYPTEST_HOME --timeline <timeline_id> --name <span_name> --phase <phase_name> -- <command> <args>",
            ...
            },
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_memory.py --repo-root $HYPTEST_HOME append --phase compile --status confirmed --case <case_name> --module <module> --platform spike --symptom '<short symptom>' --fix '<short fix>'",
                "desc": "Append one local memory record for a failure, fix, or workflow lesson.",
            },
            {
                "name": "workflow-memory-query",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/workflow_memory.py --repo-root $HYPTEST_HOME query --term '<keyword>' --limit 10",
    ...
    },
    {
        ...
        "commands": [
            {
                "name": "profile-query",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/query_spec_profile.py --spec-profile <spec_profile> --address <pa> --summary",
                "desc": "Summarize PMA/PBMT/MMIO profile rules for an address.",
            },
            {
                "name": "profile-registry",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_spec_profile_registry.py",
                "desc": "Check the profile registry and default profile mapping.",
            },
            {
                "name": "new-profile",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/new_spec_profile.py --name <profile_name> --title '<project/core title>' --update-registry",
                "desc": "Create a new spec profile skeleton from the template and register it.",
            },
            {
                "name": "profile-decision",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/query_spec_profile.py --spec-profile <spec_profile> --address <pa> --decision-only",
                "desc": "Print only matching profile default_decision values.",
            },
            {
                "name": "reason-code",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/suggest_reason_code.py --symptom '<failure symptom>'",
                "desc": "Suggest candidate reason_code values from a failure symptom.",
            },
            {
                "name": "reason-code-eval",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/eval_reason_code_suggestions.py",
    ...
    },
    {
        ...
        "commands": [
            {
                "name": "readme-check",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_readme_commands.py",
                "desc": "Check README generated command block is in sync.",
            },
            {
                "name": "readme-update",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/update_readme_commands.py",
                "desc": "Refresh README generated command block.",
            },
            {
                "name": "resource-index-check",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/check_resource_index.py",
                "desc": "Check resource_index.md mentions public scripts and key assets.",
            },
            {
                "name": "manifest-check",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/update_script_manifest.py --check",
                "desc": "Check assets/script_manifest.json is in sync with scripts/*.py.",
            },
            {
                "name": "manifest-update",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/update_script_manifest.py --write",
                "desc": "Refresh assets/script_manifest.json after adding or removing scripts.",
            },
            {
                "name": "resource-index-update",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/update_resource_index.py --write",
                "desc": "Refresh the generated resource coverage block in resource_index.md.",
            },
            {
                "name": "profile-portability",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/eval_profile_portability.py",
                "desc": "Check generic skill surfaces do not hardcode the concrete default profile.",
            },
            {
                "name": "listed-command-help",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/eval_listed_commands_help.py",
        ...
        "commands": [
            {
                ...
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/clean_generated.py --repo-root $HYPTEST_HOME",
    ...
    },
    {
        ...
        "commands": [
            {
                "name": "skill-summary",
                "cmd": "python3 $HYPTEST_WORKFLOW_SKILL_HOME/scripts/skill_summary.py",
